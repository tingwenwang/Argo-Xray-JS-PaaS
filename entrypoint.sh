...
UUID=${UUID:-'079bcbe3-d951-49f2-b6fc-08f579e1da8d'}
...
# Argo 固定域名隧道的两个参数,这个可以填 Json 内容或 Token 内容，其中 json 可以通过以下网站，在不需绑卡的情况下轻松获取: https://fscarmen.cloudflare.now.cc/
# 不需要的话可以留空，删除或在这两行最前面加 # 以注释
# ARGO_AUTH=${ARGO_AUTH} 
